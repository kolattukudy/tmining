package twitter.sentiment.utils
...
object SentimentAnalysisUtils {
  ...
  val nlpProps = {
    ...
    //props.setProperty("pos.model", "file:C:\\dev\\test-stanford-tagger-master\\models\\english-left3words-distsim.tagger");
    //props.setProperty("ner.model", "file:C:\\english.all.3class.distsim.crf.ser.gz");
